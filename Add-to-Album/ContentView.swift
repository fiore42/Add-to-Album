...
struct SelectedImage: Identifiable {
    ...
    init(index: Int, id: UUID = UUID()) { // Add an initializer to set a default value for id
        self.index = index
        self.id = id
    }
//    // Equatable conformance (automatically generated by the compiler in most cases)
//    static func == (lhs: SelectedImage, rhs: SelectedImage) -> Bool {
//        return lhs.id == rhs.id && lhs.index == rhs.index // Compare all relevant properties
//    }
}
...
//                                        selectedImage = SelectedImage(index: index) // Directly pass the index
                                        selectedImage = SelectedImage(index: index, id: UUID())  // Create a *new* SelectedImage with a unique ID
...
//                .onChange(of: selected) { newValue in // Optional, but good practice
//                    if let newValue = newValue {
//                        print("Full-screen cover presented with selectedIndex: \(newValue.index)")
//                    } else {
